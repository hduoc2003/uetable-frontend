  ...
  return (
    <main className="bg-white py-5">
      <div className="py-6 max-w-md mx-auto bg-white rounded-xl shadow-lg border">
            ...
            <div className="flex w-full justify-center relative pb-6">
              ...
              <div className="w-full flex flex-col pr-4">
                <input 
                  ...
                  <p className="text-red-500 ml-2">Không được để trống.</p>
                  )}
              </div>
            </div>
        ...
        <button className="text-lg text-black rounded-2xl px-6 py-2 font-bold ml-8 mt-16 hover:bg-slate-300">
            <Link href="/">Quay lại</Link>
          </button>
          <button className="text-lg text-white rounded-2xl bg-primary px-6 py-2 font-bold mr-8 mt-16 hover:bg-dark-primary">
